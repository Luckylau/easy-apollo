...
import lucky.apollo.portal.service.NamespaceBranchService;
...
public class NamespaceBranchController {
    ...
    public NamespaceInfo findBranch(@PathVariable String appId,
                                    @PathVariable String env,
                                    @PathVariable String clusterName,
                                    @PathVariable String namespaceName) {
        return namespaceBranchService.findBranch(appId, clusterName, namespaceName);
    }
    ...
    public NamespaceDTO createBranch(@PathVariable String appId,
        ...
        return namespaceBranchService.createBranch(appId, clusterName, namespaceName);
    }
    ...
    public void deleteBranch(@PathVariable String appId,
        ...
        boolean canDelete = permissionValidator.hasReleaseNamespacePermission(appId, namespaceName) ||
                (permissionValidator.hasModifyNamespacePermission(appId, namespaceName) &&
                        releaseService.loadLatestRelease(appId, namespaceName, clusterName) == null);
    ...
    public ReleaseDTO merge(@PathVariable String appId, @PathVariable String env,
        ...
        ReleaseDTO createdRelease = namespaceBranchService.merge(appId, clusterName, namespaceName, branchName,
    ...
    public GrayReleaseRuleDTO getBranchGrayRules(@PathVariable String appId, @PathVariable String env,
        ...
        return namespaceBranchService.findBranchGrayRules(appId, clusterName, namespaceName, branchName);
    }
    ...
    public void updateBranchRules(@PathVariable String appId, @PathVariable String env,
        ...
        namespaceBranchService
                .updateBranchGrayRules(appId, clusterName, namespaceName, branchName, rules);
