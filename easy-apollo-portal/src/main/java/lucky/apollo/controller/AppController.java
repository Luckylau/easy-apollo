...
import lucky.apollo.entity.model.AppModel;
import lucky.apollo.entity.po.AppPO;
import lucky.apollo.entity.po.RolePO;
import lucky.apollo.exception.BadRequestException;
import lucky.apollo.listener.AppChangedEvent;
import lucky.apollo.listener.AppCreationEvent;
import lucky.apollo.listener.AppDeletionEvent;
import lucky.apollo.service.AppService;
        ...
        if (!CollectionUtils.isEmpty(admins)) {
            rolePermissionService
                    .assignRoleToUsers(RoleUtils.buildAppMasterRoleName(createdApp.getAppId()),
                            admins, userService.getCurrentUsername());
        }
